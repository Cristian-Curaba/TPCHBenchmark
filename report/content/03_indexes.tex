...
The total weight of the database with the indexes on defined materialized views is \SI{23}{\giga\byte} (\num{1.6} times the size of the initial database).
...
\begin{tabular}{|| c | c c c c c | c c ||} 
 ...
 \hline
\end{tabular}
  \caption{Query timings with indexes on materialized views, in milliseconds.}
