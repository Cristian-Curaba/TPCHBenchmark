...
Each of the group component implemented a query (specifically, Della Rovere designed the first query, Capone the second one, and Stefanel the last one).
After regular meetings between the group members comparing the solo works, common substructures between queries have been detected, and the work that followed proceeded in a coral way.
